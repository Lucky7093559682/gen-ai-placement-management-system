    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {(showOnboardingModal || showEditOnboardingModal) && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-6">
          <div className="bg-slate-900 w-full max-w-3xl rounded-2xl p-6 border border-white/10 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-white">{editingOnboardingId ? 'Edit Onboarding' : 'Create New Onboarding'}</h3>
              <button
                onClick={() => {
                  setShowOnboardingModal(false);
                  setShowEditOnboardingModal(false);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-slate-300 mb-1">Employee Name *</label>
                <input
                  type="text"
