              ...
              <div className="p-8 space-y-5">
                ...
                <div>
                  ...
                  <div className="flex justify-center">
                    <ImageCropUpload
                      currentImage={profileForm.avatar && profileForm.avatar.startsWith('/uploads/') ? `${process.env.REACT_APP_API_BASE_URL || ''}${profileForm.avatar}` : profileForm.avatar || `https://api.dicebear.com/7.x/avataaars/svg?seed=${user?.id || 'user'}`}
